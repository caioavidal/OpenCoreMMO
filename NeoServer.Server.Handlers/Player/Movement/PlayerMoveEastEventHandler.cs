...
{
    public class PlayerMoveEastEventHandler : PacketHandler
    {
        ...
        public PlayerMoveEastEventHandler(IAccountRepository repository, ServerState serverState, Game game, IMap map, MapScheduler mapScheduler)
        {
        ...
        public override void HandlerMessage(IReadOnlyNetworkMessage message, Connection connection)
        {
          ...
          {
              PlayerMovementHandler.Handler(player, _map, Direction.East, connection);
          });
