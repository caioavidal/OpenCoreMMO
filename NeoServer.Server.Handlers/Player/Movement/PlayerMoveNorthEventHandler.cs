...
{
    public class PlayerMoveNorthEventHandler : PacketHandler
    {
        ...
        public PlayerMoveNorthEventHandler(IAccountRepository repository,
        ...
        public override void HandlerMessage(IReadOnlyNetworkMessage message, Connection connection)
        {
            ...
            _mapScheduler.Enqueue(() =>
                        {
                            PlayerMovementHandler.Handler(player, _map, Direction.North, connection);
                        });
        }
    }
}
