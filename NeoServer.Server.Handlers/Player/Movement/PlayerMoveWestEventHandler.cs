...
{
    public class PlayerMoveWestEventHandler : PacketHandler
    {
        ...
        public PlayerMoveWestEventHandler(IAccountRepository repository,
        ...
        public override void HandlerMessage(IReadOnlyNetworkMessage message, Connection connection)
        {
            ...
            {
                PlayerMovementHandler.Handler(player, _map, Direction.West, connection);
            });
