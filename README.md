...
> <br>To connect to the server, you can use either [OTClient](https://github.com/edubart/otclient) or [OTCv8](https://github.com/slavidodo/OpenTibia-Unit](https://github.com/OTCv8/otclientv8)y) for version 8.6.
