...
-- 	--print(SAVE_INTERVAL_CONFIG_TIME * SAVE_INTERVAL_TIME)
...
-- 	--print(string.format("[save.onTime] - Save interval type '%s' is not valid, use 'second', 'minute' or 'hour'", SAVE_INTERVAL_TYPE))
-- 	--return false
-- end
