...
namespace NeoServer.Game.Common.Contracts.World
{
    ...
    public interface IMap
    {
        ...
        void SwapCreatureBetweenSectors(ICreature creature, Location.Structs.Location fromLocation, Location.Structs.Location toLocation);
        HashSet<ICreature> GetSpectators(Location.Structs.Location fromLocation, Location.Structs.Location toLocation, bool onlyPlayers = false);
