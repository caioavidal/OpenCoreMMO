...
public class WaveEffect
{
    ...
    public static byte[,] AreaSquareWave5 =
    {
        { 1, 1, 1 },
        { 1, 1, 1 },
        { 1, 1, 1 },
    ...
    public static byte[,] DiagonalWave4 =
    {
