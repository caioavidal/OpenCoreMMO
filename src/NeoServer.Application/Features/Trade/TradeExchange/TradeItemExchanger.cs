...
namespace NeoServer.Application.Features.Trade.TradeExchange;
...
public class TradeItemExchanger
{
    ...
    public SafeTradeError Exchange(TradeRequest tradeRequest)
    {
        ...
        ItemTradedTracker.UntrackItems(Enumerable.Concat<IItem>(tradeRequest.Items, secondTradeRequest.Items));
