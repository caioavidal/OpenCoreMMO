...
using NeoServer.Modules.Chat.Vip.AddFriendToVip;
using NeoServer.Modules.Chat.Vip.LoadVipList;
using NeoServer.Modules.Combat.Events;
using NeoServer.Modules.ItemManagement.ContainerManagement.CloseContainer;
using NeoServer.Modules.ItemManagement.ContainerManagement.ModifyContent;
using NeoServer.Modules.ItemManagement.ContainerManagement.OpenContainer;
using NeoServer.Modules.Party.InviteToParty;
using NeoServer.Modules.Party.JoinParty;
using NeoServer.Modules.Party.LeaveParty;
using NeoServer.Modules.Party.PassPartyLeadership;
using NeoServer.Modules.Party.RevokeInvite;
using NeoServer.Modules.Players.Events;
using NeoServer.Modules.Players.Level.Events;
using NeoServer.Modules.Session.LogIn;
using NeoServer.Modules.Session.LogOut;

namespace NeoServer.Modules.Players;

public class PlayerEventSubscriber : ICreatureEventSubscriber, IServerEventSubscriber
{
