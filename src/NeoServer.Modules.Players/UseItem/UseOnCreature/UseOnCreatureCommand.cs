...
namespace NeoServer.Modules.Players.UseItem.UseOnCreature;
...
public class UseItemOnCreatureCommandHandler : ICommandHandler<UseItemOnCreatureCommand>
{
    ...
    public UseItemOnCreatureCommandHandler(IMapTool mapTool, IWalkToTarget walkToTarget, IMediator mediator)
    {
        _mapTool = mapTool;
