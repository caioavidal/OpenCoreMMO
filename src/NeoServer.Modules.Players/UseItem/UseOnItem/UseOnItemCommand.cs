...
namespace NeoServer.Modules.Players.UseItem.UseOnItem;

public record UseItemOnItemCommand(IPlayer Player, IItem Item, IItem Target) : ICommand;

public class UseItemOnItemCommandHandler(IWalkToTarget toTarget, IMap map) : ICommandHandler<UseItemOnItemCommand>
{
