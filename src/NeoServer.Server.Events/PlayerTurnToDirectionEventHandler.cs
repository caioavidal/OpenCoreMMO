...
{
    public class PlayerTurnToDirectionEventHandler : IEventHandler<PlayerTurnToDirectionEvent>
    {
        ...
        public void Execute(PlayerTurnToDirectionEvent evt)
        {
            ...
            foreach (var spectatorId in map.GetCreaturesAtPositionZone(player.Location))
            {
                ...
                outgoingPackets.Enqueue(new TurnToDirectionPacket(player, evt.Direction));
