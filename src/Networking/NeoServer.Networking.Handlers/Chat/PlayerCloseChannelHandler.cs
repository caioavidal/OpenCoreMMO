...
namespace NeoServer.Networking.Handlers.Chat
{
    public class PlayerCloseChannelHandler : PacketHandler
    {
        ...
        public PlayerCloseChannelHandler(IGameServer game, IChatChannelStore chatChannelStore, IGuildStore guildStore)
        {
            _game = game;
        ...
        public override void HandlerMessage(IReadOnlyNetworkMessage message, IConnection connection)
        {
            ...
            _game.Dispatcher.AddEvent(new Event(() => player.ExitChannel(channel)));
        }
    }
}