...
public class PlayerCapacityTests
{
    ...
    public void Player_capacity_increases_when_item_removed_from_equipped_backpack()
    {
        ...
        var item = ItemTestData.CreateWeaponItem(id: 100, weight: 20);
        var item2 = ItemTestData.CreateCumulativeItem(id: 101,amount:20, weight: 1);
        var item3 = ItemTestData.CreateFood(id: 102, amount:20, weight: 1);

        var innerBag = ItemTestData.CreateBackpack(weight:20);
        
        var item4 = ItemTestData.CreateFood(id: 102, amount:20, weight: 1);
        var item5 = ItemTestData.CreateCumulativeItem(id: 101,amount:20, weight: 1);
        var item6 = ItemTestData.CreateWeaponItem(id: 100, weight: 20);
        
        var item7= ItemTestData.CreateCumulativeItem(id: 103,amount:20, weight: 1); 
        var item8= ItemTestData.CreateWeaponItem(id: 100, weight: 20);
    ...
    public void Player_capacity_decreases_when_item_added_to_equipped_backpack()
    {
        ...
        var item2 = ItemTestData.CreateCumulativeItem(id: 101,amount:10, weight: 1);
        backpack.AddItem(item2);
        player.CarryStrength.Should().Be(950);
        
        var item2B = ItemTestData.CreateCumulativeItem(id: 101,amount:10, weight: 1);
        backpack.AddItem(item2B);
        player.CarryStrength.Should().Be(940);
        
        var item3 = ItemTestData.CreateFood(id: 102, amount:10, weight: 1);
        backpack.AddItem(item3);
        player.CarryStrength.Should().Be(930);
        
        var item3B = ItemTestData.CreateFood(id: 102, amount:10, weight: 1);
        ...
        var item4B = ItemTestData.CreateFood(id: 102, amount:10, weight: 1);
        innerBag.AddItem(item4B);
        player.CarryStrength.Should().Be(860);
        
        var item5 =  ItemTestData.CreateCumulativeItem(id: 101,amount:10, weight: 1);
        innerBag.AddItem(item5);
        player.CarryStrength.Should().Be(850);
        
        var item5B = ItemTestData.CreateCumulativeItem(id: 101,amount:10, weight: 1);
    ...
    public static IEnumerable<object[]> SlotItemsData =>
        new List<object[]>
        {
            new object[]
            {
                Slot.Backpack, ItemTestData.CreateBackpack(id: 105, weight: 20, new List<IItem>
                {
                    ItemTestData.CreateWeaponItem(id: 100, weight: 10),
                    ItemTestData.CreateWeaponItem(id: 101, weight: 10),
                    ItemTestData.CreateCumulativeItem(id: 101, weight: 1, amount: 20),
                    ItemTestData.CreateBackpack(id: 105, weight: 20, new List<IItem>()
                    {
                        ItemTestData.CreateWeaponItem(id: 101, weight: 10),
                        ItemTestData.CreateCumulativeItem(id: 101, weight: 1, amount: 10)
                    })
                })
            },
            ...
            new object[] { Slot.Right, ItemTestData.CreateBodyEquipmentItem(100, "", "shield", weight: 100) },
