...
public class ContainerClearTests
{
    ...
    public void Container_clear_removes_all_items_from_it()
    {
        ...
        var item1 = ItemTestData.CreateRegularItem(id: 100);
        var item2 = ItemTestData.CreateRegularItem(id: 101);
        var item3 = ItemTestData.CreateCumulativeItem(id: 101, amount: 20);
        bag.AddItem(item1);
        bag.AddItem(item2);
        bag.AddItem(item3);

        var innerBag = ItemTestData.CreateContainer();
        var item4 = ItemTestData.CreateRegularItem(id: 103);
        var item5 = ItemTestData.CreateCumulativeItem(id: 104, amount: 100);
        bag.AddItem(innerBag);
        innerBag.AddItem(item4);
        innerBag.AddItem(item5);

        var innerBag2 = ItemTestData.CreateContainer();
        var item6 = ItemTestData.CreateRegularItem(id: 103);
        var item7 = ItemTestData.CreateCumulativeItem(id: 104, amount: 15);
