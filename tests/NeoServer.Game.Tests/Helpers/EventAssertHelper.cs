...
public static class EventAssertHelper
{
    ...
    public static void WithArgs<T1,T2,T3,T4>(this IEventRecording eventRecording, Expression<Func<T1, bool>> predicate1,
        Expression<Func<T2, bool>> predicate2,
        Expression<Func<T3, bool>> predicate3,
    ...
    public static void WithArgs<T1,T2,T3,T4, T5>(this IEventRecording eventRecording, Expression<Func<T1, bool>> predicate1,
        Expression<Func<T2, bool>> predicate2,
        Expression<Func<T3, bool>> predicate3,
        Expression<Func<T4, bool>> predicate4,
