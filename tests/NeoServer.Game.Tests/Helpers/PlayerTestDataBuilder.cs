...
namespace NeoServer.Game.Tests.Helpers
{
    ...
    {
        public static IPlayer BuildPlayer(uint capacity = 100, ushort hp = 100, ushort mana = 30, ushort speed = 200,
            Dictionary<Slot, Tuple<IPickupable, ushort>> inventory = null, Dictionary<SkillType, ISkill> skills = null)
        {
            ...
            var sut = new Player(1, "PlayerA", ChaseMode.Stand, capacity, hp, 100, 1, Gender.Male, true, mana, 30,
                FightMode.Attack,
                100, 100,
