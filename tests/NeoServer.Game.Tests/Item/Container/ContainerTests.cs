...
using NeoServer.Game.Creature.Monster.Loot;
...
namespace NeoServer.Game.Tests.Item.Container;
...
public class ContainerTests
{
    private IContainer CreateContainer(byte capacity = 6, string name = "")
    {
        ...
        return new Game.Item.Items.Containers.Container(itemType, new Location(100, 100, 7));
    }
    ...
    private Game.Item.Bases.Item CreateRegularItem(ushort id, string name = "item")
    {
        var type = new ItemType();
        type.SetClientId(id);
        type.SetName(name);
    ...
    public void Constructor_Should_Create_Instance_With_Capacity_And_List_Items()
    {
        ...
        var sut = new Game.Item.Items.Containers.Container(itemType, new Location(100, 100, 7));
    ...
    public void SetParent_Should_Modify_Parent_Property()
    {
        ...
        var parentContainer = new Game.Item.Items.Containers.Container(itemType, new Location(100, 100, 7));
        var sut = new Game.Item.Items.Containers.Container(itemType, new Location(100, 100, 7));
    ...
    public void IsApplicable_Returns_True_When_ItemType_Is_Container()
    {
        ...
        Assert.True(Game.Item.Items.Containers.Container.IsApplicable(type));
        ...
        type = new ItemType();
        type.SetGroupIfNone();
        Assert.False(Game.Item.Items.Containers.Container.IsApplicable(type));
    }
